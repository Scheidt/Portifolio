          ...
          <Col xs={{ span: 24, order: 2 }} md={{ span: 16, order: 1 }}>
            <div className="ml-[20%]">
              <ul className="list-none p-0 m-0 space-y-2 text-gray-800 text-lg leading-relaxed">
                ...
                <li className="flex items-start">
                  <span className="mr-2">-</span>
                  <span>(2020) Curso de Resolução de Conflitos - Corte Catarinense de Mediação e Arbitragem</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">-</span>
                  <span>Curso de linguagem Japonesa (3 anos) - Associação Nipo Catarinense</span>
                </li>
              </ul>
            </div>
          </Col>
